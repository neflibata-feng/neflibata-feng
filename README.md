...
欢迎来到我的 GitHub！我是一名**软件工程师**，目前就读于**电子科技大学（UESTC）**，我专注于构建高效、安全的系统，并致力于**AI Agent（智能体）** 技术的研发与集成。

## 🚀 关于我

- 👨‍💻 **背景：** 软件工程在读，专业为**后端开发**，目前主攻 **AI Agent** 的开发与应用。
- 🖥️ **技术栈：** 核心编程语言是 **Java**，深耕 **Spring Boot** 框架开发；同时掌握 **Python** 以拓展技术边界，详见[技术栈](#tech-stack-cn)
- 🔍 **当前进展：** 我正在开发几个小项目，详见[我的项目经历](#project-experience-cn)
...
- **最强的多模态**
- ![Gemini 3.0 pro](https://img.shields.io/badge/-Gemini%203.0%20pro-4285F4?style=flat&logo=google&logoColor=white)
- **最强的记忆和理解能力**
- ![GPT-5.2](https://img.shields.io/badge/-GPT--5.2-00A67E?style=flat&logo=openai&logoColor=white)
- **最高的编程能力**
- ![GPT-5.2 codex](https://img.shields.io/badge/-GPT--5.2%20codex-1ABC9C?style=flat&logo=openai&logoColor=white)
- **最低的成本** 
...
- **DeepResearch Agent**
- ![Gemini DeepResearch](https://img.shields.io/badge/-Gemini%20DeepResearch-4285F4?style=flat&logo=google&logoColor=white)
- **OS Agent**
- ![OpenClaw](https://img.shields.io/badge/-OpenClaw-000000?style=flat&logo=linux&logoColor=white)
...
## 🌐 联系我
- 📧 [neflibatafeng@gmail.com](mailto:neflibatafeng@gmail.com)

---

如果你对我的项目感兴趣，或者有任何想法，欢迎随时联系！期待与你一起探讨技术！😊

---

<h2 id="english">English</h2>

Welcome to my GitHub! I'm a **software engineer** currently studying at **University of Electronic Science and Technology of China (UESTC)**. I focus on building efficient and secure systems, and I'm committed to researching, developing, and integrating **AI Agents**.

## 🚀 About Me

- 👨‍💻 **Background:** Software Engineering student, specializing in **backend development**, currently focusing on **AI Agent** development and applications.
- 🖥️ **Tech stack:** My primary language is **Java**, with deep experience in **Spring Boot** development. I also use **Python** to expand my technical boundaries. See [Tech Stack](#tech-stack-en).
- 🔍 **Current status:** I'm working on several small projects. See [Project Experience](#project-experience-en).
...
### 🤖 My Favorite LLM Rankings

- **Best multimodal model**
- ![Gemini 3.0 pro](https://img.shields.io/badge/-Gemini%203.0%20pro-4285F4?style=flat&logo=google&logoColor=white)
- **Best memory & comprehension**
- ![GPT-5.2](https://img.shields.io/badge/-GPT--5.2-00A67E?style=flat&logo=openai&logoColor=white)
